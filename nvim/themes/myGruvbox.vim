...
let s:gb.bright_orange  = ['#ff0000', 208]     " 254-128-25
...
if version >= 700
  ...
  call s:HL('TabLineFill', s:blue, s:bg1, s:invert_tabline)
  " Active tab page label
  call s:HL('TabLineSel', s:bg0, s:blue, s:invert_tabline)
  " Not active tab page label
  hi! link TabLine TabLineFill

"hi TabLine      ctermfg=White  ctermbg=Black     cterm=NONE
"hi TabLineFill  ctermfg=Black  ctermbg=Red cterm=NONE
"hi TabLineSel   cthttps://ens.domains/ermfg=Black ctermbg=DarkBlue  cterm=NONE
